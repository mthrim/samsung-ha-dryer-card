      ...
      <ha-card class=${g?"finished":""}>
        <div class="card">
          ...
          <div class="metrics">
            ...
            ${e.show_energy&&we?this.renderMetric("Cycle Energy",we,e.icons.energy):""}
          </div>
        </div>
      </ha-card>
