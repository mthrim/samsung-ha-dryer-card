...
\f\r"'\`<>=]|("|')|))|$)`,"g"),We=/'/g,Ve=/"/g,Ye=/^(?:script|style|textarea|title)$/i,ye=r=>(e,...t)=>({_$litType$:r,strings:e,values:t}),u=ye(1),Wt=ye(2),Vt=ye(3),E=Symbol.for("lit-noChange"),_=Symbol.for("lit-nothing"),Ge=new WeakMap,S=A.createTreeWalker(A,129);Lt=(r,e)=>{let t=r.length-1,i=[],n,o=e===2?"<svg>":e===3?"<math>":"",s=R;for(let l=0;l<t;l++){let a=r[l],d,c,p=-1,m=0;for(;m<a.length&&(s.lastIndex=m,c=s.exec(a),c!==null);)m=s.lastIndex,s===R?c[1]==="!--"?s=Be:c[1]!==void 0?s=je:c[2]!==void 0?(Ye.test(c[2])&&(n=RegExp("</"+c[2],"g")),s=x):c[3]!==void 0&&(s=x):s===x?c[0]===">"?(s=n??R,p=-1):c[1]===void 0?p=-2:(p=s.lastIndex-c[2].length,d=c[1],s=c[3]===void 0?x:c[3]==='"'?Ve:We):s===Ve||s===We?s=x:s===Be||s===je?s=R:(s=x,n=void 0);let g=s===x&&r[l+1].startsWith("/>")?" ":"";o+=s===R?a+Pt:p>=0?(i.push(d),a.slice(0,p)+Ke+a.slice(p)+v+g):a+v+(p===-2?l:g)}return[Je(r,o+(r[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},H=class r{constructor({strings:e,_$litType$:t},i){let n;this.parts=[];let o=0,s=0,l=e.length-1,a=this.parts,[d,c]=Lt(e,t);if(this.el=r.createElement(d,i),S.currentNode=this.el.content,t===2||t===3){let p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(n=S.nextNode())!==null&&a.length<l;){if(n.nodeType===1){if(n.hasAttributes())for(let p of n.getAttributeNames())if(p.endsWith(Ke)){let m=c[s++],g=n.getAttribute(p).split(v),f=/([.?@])?(.*)/.exec(m);a.push({type:1,index:o,name:f[2],strings:g,ctor:f[1]==="."?pe:f[1]==="?"?ue:f[1]==="@"?me:C}),n.removeAttribute(p)}else p.startsWith(v)&&(a.push({type:6,index:o}),n.removeAttribute(p));if(Ye.test(n.tagName)){let p=n.textContent.split(v),m=p.length-1;if(m>0){n.textContent=Y?Y.emptyScript:"";for(let g=0;g<m;g++)n.append(p[g],M()),S.nextNode(),a.push({type:2,index:++o});n.append(p[m],M())}}}else if(n.nodeType===8)if(n.data===qe)a.push({type:2,index:o});else{let p=-1;for(;(p=n.data.indexOf(v,p+1))!==-1;)a.push({type:7,index:o}),p+=v.length-1}o++}}static createElement(e,t){let i=A.createElement("template");return i.innerHTML=e,i}};de=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,n=(e?.creationScope??A).importNode(t,!0);S.currentNode=n;let o=S.nextNode(),s=0,l=0,a=i[0];for(;a!==void 0;){if(s===a.index){let d;a.type===2?d=new z(o,o.nextSibling,this,e):a.type===1?d=new a.ctor(o,a.name,a.strings,this,e):a.type===6&&(d=new ge(o,this,e)),this._$AV.push(d),a=i[++l]}s!==a?.index&&(o=S.nextNode(),s++)}return S.currentNode=A,n}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},z=class r{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,n){this.type=2,this._$AH=_,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=n,this._$Cv=n?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=k(this,e,t),I(e)?e===_||e==null||e===""?(this._$AH!==_&&this._$AR(),this._$AH=_):e!==this._$AH&&e!==E&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):Nt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==_&&I(this._$AH)?this._$AA.nextSibling.data=e:this.T(A.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,n=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=H.createElement(Je(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===n)this._$AH.p(t);else{let o=new de(n,this),s=o.u(this.options);o.p(t),this.T(s),this._$AH=o}}_$AC(e){let t=Ge.get(e.strings);return t===void 0&&Ge.set(e.strings,t=new H(e)),t}k(e){fe(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,n=0;for(let o of e)n===t.length?t.push(i=new r(this.O(M()),this.O(M()),this,this.options)):i=t[n],i._$AI(o),n++;n<t.length&&(this._$AR(i&&i._$AB.nextSibling,n),t.length=n)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=ze(e).nextSibling;ze(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},C=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,n,o){this.type=1,this._$AH=_,this._$AN=void 0,this.element=e,this.name=t,this._$AM=n,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=_}_$AI(e,t=this,i,n){let o=this.strings,s=!1;if(o===void 0)e=k(this,e,t,0),s=!I(e)||e!==this._$AH&&e!==E,s&&(this._$AH=e);else{let l=e,a,d;for(e=o[0],a=0;a<o.length-1;a++)d=k(this,l[i+a],t,a),d===E&&(d=this._$AH[a]),s||=!I(d)||d!==this._$AH[a],d===_?e=_:e!==_&&(e+=(d??"")+o[a+1]),this._$AH[a]=d}s&&!n&&this.j(e)}j(e){e===_?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},pe=class extends C{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===_?void 0:e}},ue=class extends C{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==_)}},me=class extends C{constructor(e,t,i,n,o){super(e,t,i,n,o),this.type=5}_$AI(e,t=this){if((e=k(this,e,t,0)??_)===E)return;let i=this._$AH,n=e===_&&i!==_||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==_&&(i===_||n);n&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},ge=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){k(this,e)}},Ot=_e.litHtmlPolyfillSupport;Ot?.(H,z),(_e.litHtmlVersions??=[]).push("3.3.2");Ze=(r,e,t)=>{let i=t?.renderBefore??e,n=i._$litPart$;if(n===void 0){let o=t?.renderBefore??null;i._$litPart$=n=new z(e.insertBefore(M(),o),o,void 0,t??{})}return n._$AI(r),n}});var be,y,Ut,Qe=$(()=>{q();q();J();J();be=globalThis,y=class extends b{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Ze(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return E}};y._$litElement$=!0,y.finalized=!0,be.litElementHydrateSupport?.({LitElement:y});Ut=be.litElementPolyfillSupport;Ut?.({LitElement:y});(be.litElementVersions??=[]).push("4.2.2")});var Xe=$(()=>{});var $e=$(()=>{q();J();Qe();Xe()});var et,T,h,F,Z,Q=$(()=>{et="samsung-ha-dryer-card",T={device_name:"dryer",title:"Dryer",show_subtitle:!0,layout_mode:"hero",show_completion_time:!0,show_status_chips:!0,show_child_lock:!0,show_power:!0,show_energy:!0,show_wrinkle_prevent_control:!0,finished_green_duration:60,show_drum_progress:!0,drum_progress_color:"#5b9cf6",completion_color_threshold_1:50,completion_color_threshold_2:30,icons:{appliance:"mdi:tumble-dryer",start:"mdi:play",pause:"mdi:pause",stop:"mdi:stop",child_lock:"mdi:lock",remote_control:"mdi:remote",wrinkle_prevent:"mdi:tshirt-crew",power:"mdi:flash",energy:"mdi:lightning-bolt",complete:"mdi:clock-outline"}},h={machineState:"machine_state",jobState:"job_state",completionTime:"completion_time",command:"command",childLock:"child_lock",remoteControl:"remote_control",wrinklePreventActive:"wrinkle_prevent_active",wrinklePreventSwitch:"wrinkle_prevent_switch",power:"power",cycleEnergy:"cycle_energy"},F={cooling:"Cooling",delay_wash:"Delayed",drying:"Drying",finished:"Finished",none:"Idle",refreshing:"Refreshing",weight_sensing:"Sensing Load",wrinkle_prevent:"Wrinkle Prevent",dehumidifying:"Dehumidifying",ai_drying:"AI Drying",sanitizing:"Sanitizing",internal_care:"Internal Care",freeze_protection:"Freeze Protection",continuous_dehumidifying:"Continuous Dehumidifying",thawing_frozen_inside:"Thawing"},Z={run:"Running",pause:"Paused",stop:"Stopped"}});var dt={};vt(dt,{SamsungHADryerCardEditor:()=>te});var Dt,Rt,Mt,te,Se=$(()=>{$e();Q();Dt=[{key:"machine_state_entity",label:"Machine State Entity"},{key:"job_state_entity",label:"Job State Entity"},{key:"completion_time_entity",label:"Completion Time Entity"},{key:"command_entity",label:"Command Entity"},{key:"child_lock_entity",label:"Child Lock Entity"},{key:"remote_control_entity",label:"Remote Control Entity"},{key:"wrinkle_prevent_active_entity",label:"Wrinkle Prevent Active Entity"},{key:"wrinkle_prevent_switch_entity",label:"Wrinkle Prevent Switch Entity"},{key:"power_entity",label:"Power Entity"},{key:"energy_entity",label:"Energy Entity"}],Rt=[{key:"show_subtitle",label:"Show subtitle"},{key:"show_completion_time",label:"Show completion time"},{key:"show_status_chips",label:"Show status chips"},{key:"show_child_lock",label:"Show child lock badge"},{key:"show_power",label:"Show power"},{key:"show_energy",label:"Show cycle energy"},{key:"show_wrinkle_prevent_control",label:"Show wrinkle prevent control"},{key:"show_drum_progress",label:"Show drum progress fill"}],Mt=[{key:"appliance",label:"Appliance Icon"},{key:"start",label:"Start Icon"},{key:"pause",label:"Pause Icon"},{key:"stop",label:"Stop Icon"},{key:"child_lock",label:"Child Lock Icon"},{key:"remote_control",label:"Remote Icon"},{key:"wrinkle_prevent",label:"Wrinkle Prevent Icon"},{key:"power",label:"Power Icon"},{key:"energy",label:"Energy Icon"},{key:"complete",label:"Completion Icon"}],te=class extends y{static properties={hass:{},_config:{state:!0}};static styles=U`
  ...
  `;getStateFlags(e){return{isRunning:e==="run",isPaused:e==="pause",isStopped:e==="stop"}}renderChip(e,t,i){return u`
    ...
    `}render(){if(!this.hass||!this._config)return u``;let e=this._config,t=it(e),i=B(this.hass,t[h.machineState]),n=i?i.state:void 0,o=X(this.hass,t[h.jobState]),s=X(this.hass,t[h.completionTime]),l=B(this.hass,t[h.power]),a=B(this.hass,t[h.cycleEnergy]),d=P(n);d?!this._cachedState&&!this._historyPending&&(this._historyPending=!0,this._fetchLastKnownState(t).then(L=>{L&&(this._cachedState=L),this._historyPending=!1,this.requestUpdate()})):this._cachedState={machineStateEntity:i,machineState:n,jobState:o,completion:s,powerState:l,energyState:a};let c=d&&this._cachedState?this._cachedState:null,p=c?c.machineStateEntity:i,m=c?c.machineState:n,g=c?c.jobState:o,f=c?c.completion:s,N=c?c.powerState:l,ie=c?c.energyState:a,{isRunning:re,isPaused:Ee,isStopped:ke}=this.getStateFlags(m),w=j(this.hass,t[h.wrinklePreventActive]),pt=w||ot(p,e.finished_green_duration),ut=w?"Finished":rt(m,g),mt=w?"Wrinkle Prevent":nt(m,g),ne=!w&&e.show_completion_time&&st(m,f),gt=ne?ct(N,f,e):null,_t=(()=>{if(!e.show_drum_progress||!re&&!Ee||w)return null;let L=we(N,f);if(L===null)return null;let yt=e.drum_progress_color||"#5b9cf6",bt=.1+(100-L)*.009,Oe=`background: ${yt}; transform: translate(-50%, -50%) scale(${bt});`;if(f){let W=(new Date(f).getTime()-Date.now())/6e4;if(W<=10&&W>0){let oe;W>5?oe=3:oe=3-(5-W)/5*2.25,Oe+=` animation: pulse ${oe}s ease-in-out infinite;`}}return Oe})(),Ce=j(this.hass,t[h.wrinklePreventSwitch]),Te=j(this.hass,t[h.childLock]),Pe=j(this.hass,t[h.remoteControl]),Ne=N?xe(this.hass,N.state,N.attributes.unit_of_measurement):"",Le=ie?xe(this.hass,ie.state,ie.attributes.unit_of_measurement):"",ft=["drum",re?"running":""].filter(Boolean).join(" ");return u`
      <ha-card class=${[pt?"finished":"",d?"stale":""].filter(Boolean).join(" ")}>
        <div class="card">
          ...
          ${e.show_status_chips?u`
                <div class="chips">
                  ${e.show_child_lock?this.renderChip(e.icons.child_lock,Te?"Child Lock On":"Child Lock Off",Te):""}
